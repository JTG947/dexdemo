...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_d104ebcc0b13db50, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_d104ebcc0b13db50, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "dexdemo.dexdemo.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "dexdemo.dexdemo.QueryParamsResponse")
}

func init() { proto.RegisterFile("dexdemo/dexdemo/query.proto", fileDescriptor_d104ebcc0b13db50) }

var fileDescriptor_d104ebcc0b13db50 = []byte{
	// 292 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x4e, 0x49, 0xad, 0x48,
	0x49, 0xcd, 0xcd, 0xd7, 0x87, 0xd1, 0x85, 0xa5, 0xa9, 0x45, 0x95, 0x7a, 0x05, 0x45, 0xf9, 0x25,
	...
	0x9c, 0xc4, 0x06, 0x0e, 0x21, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xc4, 0x34, 0x11, 0xe7,
	0xe2, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dexdemo.dexdemo.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dexdemo.dexdemo.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "dexdemo.dexdemo.Query",
	...
	Metadata: "dexdemo/dexdemo/query.proto",
}
